...
import com.example.claimchapchap.databinding.FragmentActonlyGoldQuoteBinding
import com.example.claimchapchap.databinding.FragmentComprehensiveGoldQuoteBinding

class GoldQuoteFragment : Fragment() {

    private lateinit var binding: FragmentActonlyGoldQuoteBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        // Inflate the layout for this fragment
        binding = FragmentActonlyGoldQuoteBinding.inflate(layoutInflater)
