...
class BronzeMobilePayment : Fragment() {
    ...
    override fun onCreateView(
        ...
        back.setOnClickListener{
            findNavController().navigate(R.id.action_bronzeMobilePayment_to_bronzePaymentFragment3)
        }
        val next: Button = binding.button4
        next.setOnClickListener{
            findNavController().navigate(R.id.action_bronzeMobilePayment_to_mainActivity3)
        }
        return view
    }
}